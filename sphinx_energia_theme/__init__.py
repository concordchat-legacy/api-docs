...
from sphinx_energia_theme._version import version
from sphinx_energia_theme.extensions import (
    hero_box,
    multiversion,
    navigation,
    panel_box,
...
from sphinx_energia_theme.lexers import cql, ditaa
...
def setup(app):
    """Setup theme"""
    app.add_html_theme("sphinx_energia_theme", path.abspath(path.dirname(__file__)))
